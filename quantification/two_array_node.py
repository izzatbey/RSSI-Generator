...
parser = argparse.ArgumentParser(description='Data quantification using 2-Array.')
...
save_quantized_rssi(os.path.join(args.destination, "Kuantifikasi_Node.csv"), quantized_rssi_data)
